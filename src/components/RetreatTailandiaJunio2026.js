    ...
    return (<>
            <div className="cover-shot-container">
                <div className="cover-shot-caption cover-shot-caption-light">
                    <h1>Santosha, Retiro de Yoga y Bienestar</h1>
            ...
            <main role="main" className="container">
                ...
                <div className="container details text-justify">
                    ...
                    <div className="row">
                        <div className="col-md-6 text-justify">
                            <h3 className="text-center text-justify">Santosha, Retiro de Yoga y Bienestar</h3>
                            <h3 className="text-center text-justify">Sanar, Soltar, Plenitud desde el Corazón</h3>
                        ...
                        <div className="col-md-5 text-justify">
                            ...
                            <ul>
                                ...
                                <li>2 Comidas saludables e inolvidablemente deliciosas elaboradas por el Executive Chef del Resort:
                                    <ul>
                                        <li>Desayuno Buffet: Disfruta de una amplia variedad de alimentos nutritivos y saludables</li>
                                        <li> Almuerzo Buffet: 3 Course Meal con ingredientes de alta calidad recomendados por el Executive Chef</li>
                                    </ul>
                                </li>
                                <li>Transporte desde o hacia el Aeropuerto (un solo trayecto)</li>
                    ...
                    <div>
                        <h2 className="text-center text-justify double-space-before">Santosha- Programación:</h2>
                        ...
                        <div className="row space-before">
                            ...
                            <div className="col-md-8">
                                <ul>
                                    ...
                                    <li>Pranayama Workshop, Aprenderás diferentes técnicas de respiración para aplicarlas en tu día a día, tendrás un kit de herramientas al cual accederás para navegar y transformar tus emociones más bajas y volver a la tranquilidad y calma.</li>
                                    <li>Tiempo libre para descansar, escribir, leer, disfrutar de la piscina, o simplemente conectar con el resto de los integrantes del retiro</li>
                        ...
                        <div className="row space-before">
                            ...
                            <div className="col-md-8">
                                <ul>
                                    <li>Excursión:</li>
                                    <li>Paseo en Catamaran en donde conectaremos aún mas con la naturaleza, podremos disfrutar de paisajes impresionantes, del sol, el viento, el mar cristalino y dos playas hermosas, serán unas horas de pura diversión</li>
                        ...
                        <div className="row space-before">
                            ...
                            <div className="col-md-8">
                                <ul>
                                    ...
                                    <li>Workshop Sorpresa</li>
                                    <li>Master Class: Movilidad y Flexibilidad, Asanas/Posturas Invertidas & Backbends</li>
                                    <li> Integración con la Sangha/Comunidad, charla, juegos o si prefieres tiempo para ti solito/a .</li>
                                </ul>
                            </div>
                            <div className="col-md-2"/>
                            <div className="col-md-2">
                        ...
                        <div className="row space-before">
                            ...
                            <div className="col-md-8">
                                <ul>
                                    <li>Día Libre para que te relajes en el Resort o explores las Isla por tu cuenta, este día tendrás la oportunidad de estar tu solit@ o armar un plan lindo con otr@s participantes del Retiro que vaya de acuerdo a tu ritmo y energía. (En este día, solo el desayuno está incluido si lo tomas en el Resort a las horas programadas)</li>
                                    <li>Clase de Vinyasa Yoga al Amanecer (Opcional)</li>
                                    <li>Integración con la Sangha/Comunidad, charla, juegos o si prefieres tiempo para ti solito/a (Opcional).</li>
                                </ul>
                            </div>
                        ...
                        <div className="row space-before">
                            ...
                            <div className="col-md-8">
                                <ul>
                                    ...
                                    <li>Pranayama, Meditación</li>
                                    <li>Taller de Meditación y Manifestación, Ir Hacia Adentro - Abraza tus emociones, vulnerabilidad y suelta aquello que no te deja avanzar libremente</li>
                                    <li>Yoga Nidra para integrar toda la energía que se moverá desde el día uno.</li>
                                    <li>Excursión:</li>
                                    <li>Alista tu bikini porque visitaremos una playa hermosa al sur de la Isla. Caminata para disfrutar el atardecer, la vista hacia el mar y otras islas.</li>
                                </ul>
                            </div>
                            <div className="col-md-2"/>
                            <div className="col-md-2">
                ...
                <div className="row double-space-before">
                    ...
                    <div className="col-md-6">
                        ...
                        <p>Alojamiento moderno en un Resort con una vista preciosa a la ciudad de Phuket y la bahía de Phang Nga.</p>
                        <p>Deluxe Room (con dos camas individuales): Espaciosa habitación con dos camas individuales, escritorio, aire acondicionado y acceso a WiFi gratuito. La habitación incluye baño privado con ducha.</p>
                    </div>
                ...
                <div className="row double-space-before">
                    ...
                    <div className="col-md-6">
                        <ContactForm yogaClassType={ClassType.RetreatTailandiaMayo2026}/>
                    </div>
                    <div className="col-md-3"></div>
                </div>
